  ...
  function IsEmail(email) {
	...
	var Room   = obj.find("input#room").val();

	var Floor   = obj.find("input#floor").val();
   ...
   if( !IsEmail( Email ) ) {
	...
	obj.find(".noticefailed").append("<img alt='loading' class='loading' src='"+onetone_params.themeurl+"/images/loading.gif' />");
	 ...
	 jQuery.ajax({
				 ...
				 data:"Name="+Name+"&Email="+Email+"&Message="+Message+"&Floor="+Floor+"&Room="+Room+"&sendto="+sendto+"&action=onetone_contact",
